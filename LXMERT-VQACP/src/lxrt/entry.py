...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, subs_conf, sents, feats, visual_attention_mask=None):
        train_features = convert_sents_to_features(
            sents, self.max_seq_length, self.tokenizer)
        ...
        # print("LXRTEncoder_entry_inference")
        # print(subs_conf.shape)
        output = self.model(subs_conf, input_ids, segment_ids, input_mask,
                            visual_feats=feats,
                            visual_attention_mask=visual_attention_mask)
        return output
