...
def parse_args():
    ...
    parser.add_argument('--loadDVQA', type=str, default=None,
                        help='Load the DVQA model partially (usually the fine-tuned model).')
    ...
    # additional parameters for the causal models
